    ...
    return (
      <div className="Container7">
        ...
        <div id="container7Id" className="container7Text">
          ...
          <p>
            Within seconds they'll have a rich 3D GIF animation, branded and  suited up for endless social sharing.
            There's nothing back and forth  about your growing engagement.
          </p>
        </div>
      </div>
    );
